...
public class TimeSheetServiceImpl {
	...
	public EQTimeSheetDetails populateEntityFromDao(String date, String leave, String submitter, String user) {
		...
		if (leave.equalsIgnoreCase("Present Full Day")) {
			day.setIsfullDay("Present Full Day");
	...
	public String fingFirstLogin(String userName) {
		return timeSheetDao.isFirstLogin(userName);
	}

	public void updateFirstLogin(String userName) {
		timeSheetDao.updateFirstLogin(userName);
	}

	public void updatePassword(LoginBean loginBean, String username) {
		// encrypt password
		BCryptPasswordEncoder passwordEncoder = new BCryptPasswordEncoder();
		String password = passwordEncoder.encode(loginBean.getPassword());
		timeSheetDao.updatePassword(password, username);

	}

	public void generateReport(Date startDate, Date endDate) {
		Map<String, List<String>> leaveMap = timeSheetDao.generateReport(startDate, endDate);
	}
