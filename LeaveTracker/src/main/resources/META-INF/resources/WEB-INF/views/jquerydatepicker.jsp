...
<script>
	window.onload = function() {
		document.getElementById('stopFuture').style.display = 'none';
	};
	$(function() {
		/* $("stopFuture").hide(); */
		var startDate;
...
<body>
	<div>
		...
		<header> <span class="title"><span style="font-size: 21px;" class="glyphicon glyphicon glyphicon-screenshot"></span> Leave Tracker</span> <span
			class="userInfo"><span class="glyphicon glyphicon-tag"
			style="font-size: 16px;" aria-hidden="true"></span> 1989 &nbsp;&nbsp;<span
		...
		<div align="center" style="width: 100%; margin-top: 15px;" class="row">
			...
			<div class="col-lg-10" style="margin-left: 15px;">
				<table class="table table-striped" align="center">
					...
					<thead>
						<tr>
							<td colspan="3" style="background: #fff; color: #aaa; vertical-align: middle;">
							...
							<td colspan="4" style="background: #fff;">
								...
								<div class="row" style="margin-bottom: 10px;">
									...
									<div class="col-md-2">
										<button class="btn btn-success btn-md"><span style="font-size: 16px;" class="glyphicon glyphicon-floppy-disk"></span> Save</button>
									</div>
									<!-- /.col-lg-6 -->
								</div> <!-- /.row -->
