...
<body>
	<div>
		...
		<div class="row" style="margin-top: 10%">
			<form:form action="/viewtimeSheet/savePasswordDetails"
				...
				<div class="shadow col-lg-2  col-lg-offset-5">
					...
					<table align="center" cellspacing="10">
						<tr>
							...
							<td><form:input path="empId" id="txt_emp_id" readonly="true" />
								<form:errors path="empId" cssClass="error" element="div" />
						...
						<tr>
							<td><label for="txt_emp_con_password">Confirm
									Password</label><span class="empDetails"></span></td>
							<td><form:input path="confirmPassword"
									id="txt_emp_con_password" /> <form:errors
									path="confirmPassword" cssClass="error" element="div" />
							...
							<td colspan="2" align="center">
								<button class="btn btn-success btn-md">
									<span style="font-size: 16px;"
										class="glyphicon glyphicon-log-in"></span> &nbsp;Submit
								</button>
							</td>
						</tr>
					</table>
