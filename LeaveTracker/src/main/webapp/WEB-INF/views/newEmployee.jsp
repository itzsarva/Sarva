			...
			<div class="shadow col-lg-4  col-lg-offset-4">
				...
				<form:form modelAttribute="registerBean"
					...
					<table class="table table-striped">
						...
						<tr>
							<td><label for="txt_emp_pactive">Is Productive</label></td>
							<td><form:checkbox path="employeeProductive"
									name="txt_emp_pactive" value="true" /> <form:errors
									path="employeeProductive" cssClass="error" element="div" />
								<div id="employeeProductive.errors" class="error"></div></td>
						</tr>
						<tr>
							<td><label for="txt_emp_pactive">Is Admin</label></td>
							<td><form:checkbox path="isAdmin" name="txt_emp_pactive"
									value="true" /> <form:errors path="isAdmin" cssClass="error"
									element="div" />
								<div id="isAdmin.errors" class="error"></div></td>
						</tr>
						<tr>
							<td><label for="txt_emp_pactive">Is Active</label></td>
							...
							<td colspan="2" align="center">
								<div>
									...
									<button type="submit" class="btn btn-success btn-md"
										name="action" value="editEmployee">Submit Edited</button>
								</div>
							</td>
						</tr>
					</table>
