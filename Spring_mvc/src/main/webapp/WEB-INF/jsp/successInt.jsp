...
<html>
<title>successint.jsp</title>

<h6>SEE this gets rendered if you provide an interceptor okay?</h6>
<body>
	...
	And the Drum rolls the value which was set in before the view was
	rendered is
	<C:out value="${sarva}"></C:out>
</body>
